  ...
  <Layout>
    ...
    <div tw="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        ...
        <p tw="text-sm my-2">
          <h3 tw="font-bold inline">Maintainer.</h3> Core Team member of{" "}
          <Link href="https://symfony.com">Symfony</Link> and{" "}
          <Link href="https://api-platform.com">API Platform</Link>. Creator of
          Companienv, Tolerance and{" "}
      ...
      <div>
        ...
        <p>
          <Link href="https://birdie.care">
            <strong>Birdie Care</strong>. Helping elderlies to live healthier
            and longer in their own homes.
          </Link>
        </p>
        <p>
          <Link href="https://www.miro-board.live/">
            <strong>Miro Board Alive</strong>. Exposes an API or connect a
            Google Spreadsheet with your Miro boards.
          </Link>
        </p>
        <p>
          <Link href="https://letsexperiment-today.herokuapp.com/">
            <strong>Let's Experiment.</strong> Design, measure and track your
            experiments.
          </Link>
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          <strong>Technical Team Health</strong> Metrics and engaging awards
          from Git repositories activity.
        </p>
        <p>
          <Link href="https://web.archive.org/web/20190122152504/https://continuouspipe.io/">
            <span tw="font-mono text-gray-400">2018</span>{" "}
            <strong>ContinuousPipe</strong>. Continuous deployment solution for
            your containerized applications to Kubernetes clusters.
          </Link>
        </p>
        <p>
